import { ExperienceSectionType } from '../types/sections';
  ...
  experiences: [
    {
      ...
      tasks: [
        ...
        'Building offline and online mode support for comprehensive device protection.',
        'Optimizing software performance for low-resource environments.',
      ],
    },
    {
      ...
      tasks: [
        ...
        'Collaborating with distributed teams to ensure timely project delivery.',
      ],
    },
    {
      ...
      tasks: [
        ...
        'Optimized relational database models for scalable performance.',
      ],
    },
    {
      ...
      tasks: [
        ...
        'Conducted R&D on IoT integration for industrial safety.',
      ],
    },
    {
      ...
      tasks: [
        ...
        'Integrated backend databases and APIs for real-time environmental data.',
      ],
    },
  ],
};
