...
const Skills = () => {
  ...
  const totalStats = {
    ...
    avgProf: Math.round(softwareSkills.reduce((acc, curr) => acc + curr.level, 0) / softwareSkills.length),
  };
  ...
  return (
    <section id="skills" className="py-24 px-6 max-w-7xl mx-auto">
      ...
      <div className="mt-32 grid grid-cols-2 lg:grid-cols-4 gap-8 bg-gray-900 rounded-[2.5rem] p-10 text-white shadow-2xl relative overflow-hidden">
        ...
        <div className="text-center relative z-10">
          ...
          <div className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em]">Avg Years Exp</div>
        </div>
        <div className="text-center relative z-10">
          <div className="text-5xl font-black text-blue-400 mb-2">{totalStats.specialty}</div>
          <div className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em]">Specialty Areas</div>
        </div>
        <div className="text-center relative z-10">
          <div className="text-5xl font-black text-blue-400 mb-2">{totalStats.avgProf}%</div>
          <div className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em]">Avg Proficiency</div>
        </div>
      </div>
    </section>
  );
